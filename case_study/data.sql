...
CREATE TRIGGER user_insert 
    ...
    FOR EACH ROW 
BEGIN
    insert into user (username, password) values(new.email, "123");
END$$
DELIMITER ;
...
-- insert email vào employee 
UPDATE `cs4_furama`.`employee` SET `username` = 'annguyen@gmail.com' WHERE (`id` = '1');
UPDATE `cs4_furama`.`employee` SET `username` = 'binhlv@gmail.com' WHERE (`id` = '2');
UPDATE `cs4_furama`.`employee` SET `username` = 'thiyen@gmail.com' WHERE (`id` = '3');
UPDATE `cs4_furama`.`employee` SET `username` = 'toan0404@gmail.com' WHERE (`id` = '4');
UPDATE `cs4_furama`.`employee` SET `username` = 'phatphat@gmail.com' WHERE (`id` = '5');
UPDATE `cs4_furama`.`employee` SET `username` = 'annghi20@gmail.com' WHERE (`id` = '6');
UPDATE `cs4_furama`.`employee` SET `username` = 'nhh0101@gmail.com' WHERE (`id` = '7');
UPDATE `cs4_furama`.`employee` SET `username` = 'donghanguyen@gmail.com' WHERE (`id` = '8');
...
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('4', '1');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('5', '1');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('6', '2');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('7', '2');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('8', '2');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('9', '2');
INSERT INTO `cs4_furama`.`user_role` (`user_id`, `role_id`) VALUES ('10', '2');
